...
mv /"$ROS_DISTRO"_ws/"$SA_NAME"/simulation_ws/build/private/"$SA_NAME"/bundle-output/simulation_ws_dependency_sources.tar.gz /shared/simulation_ws_dependency_sources.tar.gz